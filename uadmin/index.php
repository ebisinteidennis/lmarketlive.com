	                ...
	                <div class="card-body">
	                    <div class="d-flex justify-content-between">
	                        <div>
	                            ...
	                            <h2 class="mt-4 ff-secondary fw-semibold"><?php echo $ct ?><span class="" ><?php echo $total1 ;?></span></h2>
	                ...
	                <div class="card-body">
	                    <div class="d-flex justify-content-between">
	                        <div>
	                            ...
	                            <h2 class="mt-4 ff-secondary fw-semibold"><?php echo $ct ?><span class="" ><?php echo $total3;?></span></h2>
	                        </div>
	                        <div>
	                            <div class="avatar-sm flex-shrink-0">
	                                <span class="avatar-title bg-soft-info rounded-circle fs-2">
	                ...
	                <div class="card-body">
	                    <div class="d-flex justify-content-between">
	                        <div>
	                            ...
	                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="" data-target="">
	                                
	                                <?php
                                        // Check if $withdraw is not null before rounding
                                        if ($withdraw !== null) {
                                            echo round($withdraw, 2);
                                        } else {
                                            echo '0.00'; // Default value when $withdraw is null
                                        }
                                        ?>
	                ...
	                <div class="card-body">
	                    <div class="d-flex justify-content-between">
	                        <div>
	                            ...
	                            <h2 class="mt-4 ff-secondary fw-semibold"><span class="" data-target=""><?php echo $ct ?><?php echo round($deposit,2);?></span></h2>
	                        </div>
	                        <div>
	                            <div class="avatar-sm flex-shrink-0">
	                                <span class="avatar-title bg-soft-info rounded-circle fs-2">
